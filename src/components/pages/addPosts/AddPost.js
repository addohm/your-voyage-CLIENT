    ...
    return (
        <div className="f g50 wfc m0a">
            <form className="w600 m0a mt" onSubmit={(e) => addOrEditPost(e)}>
                ...
                {isInputVisible && <Input defaultValue={post?.link} className="db h50 w300 fz18 mb" name="link" value={linkValue} onChange={(e) => linkValueSet(e.target.value)} placeholder="link / affiliate link" />}
